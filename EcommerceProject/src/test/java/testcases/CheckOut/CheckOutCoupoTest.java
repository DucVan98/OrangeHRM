...
public class CheckOutCoupoTest extends BaseClass {
    ...
    @Test(priority = 1,description = "Kiểm tra checkout thành công khi áp mã giảm giá")
    public void CheckOutWithCoupoCode() throws Exception {
        ExcelHelpers excel = new ExcelHelpers();
